    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          <Topic>
            <Circle />
            <span>Building for You, That's What We Do!</span>
          </Topic>
          <Title>Taking your presence to the next level</Title>
          <SubText>
          We personalize our tools to meet the unique needs of academics and researchers.
          </SubText>
          {/* <CTA>
            Contact US &nbsp;
